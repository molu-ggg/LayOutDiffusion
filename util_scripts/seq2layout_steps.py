...
for iidx in range(50):
    ...
    # ]
    labels_RICO =['床(正视)', '落地床头柜(正视)', '装饰画(正视)', '竖向装饰画(正视)', 
              '扫地机器人(正视)', '横向装饰画(正视)', '落地梳妆台组合(正视)', '吊灯(正视)', 
              '落地梳妆台(正视)', '台灯(正视)', '床与床头柜组合(正视)', '落地灯(左视)', '床(左视)', 
              '落地灯(右视)', '落地床头柜(左视)', '竖向装饰画(左视)', '落地灯(正视)', '单人床尾凳(正视)', 
              '壁挂空调(正视)', '吸顶灯(正视)', '床尾凳(正视)', '落地无镜梳妆台组合(正视)', '床(右视)', 
              '装饰画(右视)', '落地床头柜(右视)', '落地空调(正视)', '空气净化器(正视)', '桌面加湿器(正视)', 
              '衣帽架(正视)', '双门衣柜(正视)', '空气净化器(右视)', '多门衣柜(左视)', '装饰画(左视)', '多门衣柜(右视)', 
              '横向装饰画(左视)', '横向装饰画(右视)', '台灯(左视)', '吸顶灯(左视)', '加湿器(正视)', '吊灯(右视)', '四门衣柜(右视)', 
              '四门衣柜(左视)', '壁挂空调(左视)', '四门衣柜(正视)', '壁挂空调(右视)', '落地梳妆台组合(右视)', '吸尘器(左视)', '吸尘器(正视)', 
              '扫地机器人(右视)', '竖向装饰画(右视)', '洗地机(正视)', '落地梳妆台(右视)']
    max=0
